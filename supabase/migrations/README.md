...
| 023 | provider_price_v0_1 | Versioned DataForSEO SERP standard-task expected price (`DFS_SERP_STD_TASK_V1`, 600 µUSD/task) for QA financial reconciliation (CST001/CST002). Ops cost-registry seed, **not** a methodology change; hand-written + idempotent |
