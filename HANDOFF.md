...
4. **Remaining (build step 3):** the cadence driver + `RUN_PAID_PANEL` gate + Railway wiring. Then a graduated **paid Sentinel wave on explicit owner "go" (Sentinel-first)** → evaluate COMPLETE → only then a Full Panel.
